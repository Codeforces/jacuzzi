...
public class JacuzziTest extends TestCase {
    ...
    protected void setUp() throws Exception {
        ...
        connection.createStatement().execute("CREATE TABLE ConfigurationObject (id INT GENERATED BY DEFAULT AS IDENTITY (START WITH 1), experience INT NOT NULL)");

        connection.createStatement().execute("DROP TABLE CashForLevel IF EXISTS");
        connection.createStatement().execute("CREATE TABLE CashForLevel (level BIGINT PRIMARY KEY, cash BIGINT NOT NULL, premiumCash BIGINT NOT NULL, a BIGINT NOT NULL)");
